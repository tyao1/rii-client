Sending UDP is working properly, by using react-native-udp...  
But React Native certainly doesn't have good support for multitouch event, which is critical for the gamepad. I'm gonna just develop one natively.


This project was bootstrapped with [Create React Native App](https://github.com/react-community/create-reac
  t-native-app).
